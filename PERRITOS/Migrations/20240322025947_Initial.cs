    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Adoptados", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Adoptados_Perritos_PerritoId",
                        column: x => x.PerritoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Perritos_DiscapacidadId",
                table: "Perritos",
